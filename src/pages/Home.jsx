...
const Home = () => {  
  ...
  const shareBudgetBuddy = async () => {
    ...
    return (
        <>
        <Navigation />
        <body className="bg-gradient-to-r from-white to-blue-200 ">
...
{/* <footer className="bg-gradient-to-r from-gray-400 to-gray-600   text-white p-4 mt-5 rounded-lg" >
...
<footer className="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100">
  <div className="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
            ...
            <a className="hover:opacity-75" href="/howto"> How to </a>
            <a className="hover:opacity-75" href="/login"> login </a>
    ...
    <p className="mt-8 font-medium text-m text-gray-800">
      © 2023 Budget-Buddy by -aadil
    </p>
  </div>
</footer>
</body>
